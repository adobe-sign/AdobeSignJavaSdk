...
import io.swagger.client.model.DetailedWidgetParticipantSetInfo;
import io.swagger.client.model.Note;
import io.swagger.client.model.UserWidgets;
import io.swagger.client.model.VisibilityInfo;
import io.swagger.client.model.WidgetAgreements;
import io.swagger.client.model.WidgetCreationResponse;
import io.swagger.client.model.WidgetDocuments;
import io.swagger.client.model.WidgetEventList;
import io.swagger.client.model.WidgetInfo;
import io.swagger.client.model.WidgetMembersInfo;
import io.swagger.client.model.WidgetStateInfo;
import io.swagger.client.model.WidgetViewInfo;
import io.swagger.client.model.WidgetViews;
...
public class WidgetsApi {
     ...
     */
    public com.squareup.okhttp.Call createWidgetCall(String authorization, WidgetInfo widgetInfo, String xApiUser, String xOnBehalfOfUser, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createWidgetValidateBeforeCall(String authorization, WidgetInfo widgetInfo, String xApiUser, String xOnBehalfOfUser, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public WidgetCreationResponse createWidget(String authorization, WidgetInfo widgetInfo, String xApiUser, String xOnBehalfOfUser) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<WidgetCreationResponse> createWidgetWithHttpInfo(String authorization, WidgetInfo widgetInfo, String xApiUser, String xOnBehalfOfUser) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call createWidgetAsync(String authorization, WidgetInfo widgetInfo, String xApiUser, String xOnBehalfOfUser, final ApiCallback<WidgetCreationResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWidgetAuditTrailCall(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getWidgetAuditTrailValidateBeforeCall(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetAuditTrailCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public byte[] getWidgetAuditTrail(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser) throws ApiException {
        ApiResponse<byte[]> resp = getWidgetAuditTrailWithHttpInfo(authorization, widgetId, xApiUser, xOnBehalfOfUser);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<byte[]> getWidgetAuditTrailWithHttpInfo(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser) throws ApiException {
        com.squareup.okhttp.Call call = getWidgetAuditTrailValidateBeforeCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWidgetAuditTrailAsync(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, final ApiCallback<byte[]> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetAuditTrailValidateBeforeCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param participantId The ID of the participant to be used to retrieve documents. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWidgetFormDataCall(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getWidgetFormDataValidateBeforeCall(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetFormDataCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, ifNoneMatch, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public byte[] getWidgetFormData(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch) throws ApiException {
        ApiResponse<byte[]> resp = getWidgetFormDataWithHttpInfo(authorization, widgetId, xApiUser, xOnBehalfOfUser, ifNoneMatch);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<byte[]> getWidgetFormDataWithHttpInfo(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch) throws ApiException {
        com.squareup.okhttp.Call call = getWidgetFormDataValidateBeforeCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, ifNoneMatch, null, null);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWidgetFormDataAsync(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch, final ApiCallback<byte[]> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWidgetFormDataValidateBeforeCall(authorization, widgetId, xApiUser, xOnBehalfOfUser, ifNoneMatch, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<byte[]>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public WidgetInfo getWidgetInfo(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch) throws ApiException {
        ApiResponse<WidgetInfo> resp = getWidgetInfoWithHttpInfo(authorization, widgetId, xApiUser, xOnBehalfOfUser, ifNoneMatch);
        return resp.getData();
    }
     ...
     * @param xOnBehalfOfUser The userId or email in the format &lt;b&gt;userid:{userId} OR email:{email}.&lt;/b&gt; of the user that has shared his/her account (optional)
     * @param ifNoneMatch Pass the value of the e-tag header obtained from the previous response to the same request to get a RESOURCE_NOT_MODIFIED(304) if the resource hasn&#39;t changed. (optional)
     * @return ApiResponse&lt;WidgetInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<WidgetInfo> getWidgetInfoWithHttpInfo(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<WidgetInfo>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWidgetInfoAsync(String authorization, String widgetId, String xApiUser, String xOnBehalfOfUser, String ifNoneMatch, final ApiCallback<WidgetInfo> callback) throws ApiException {
     ...
     * @param xApiUser The userId or email of API caller using the account or group token in the format &lt;b&gt;userid:{userId} OR email:{email}.&lt;/b&gt; If it is not specified, then the caller is inferred from the token. (optional)
     * @param xOnBehalfOfUser The userId or email in the format &lt;b&gt;userid:{userId} OR email:{email}.&lt;/b&gt; of the user that has shared his/her account (optional)
     * @param showHiddenWidgets A query parameter to fetch all the hidden widgets along with the visible widgets. (optional)
     * @param cursor Used to navigate through the pages. If not provided, returns the first page. (optional)
     * @param pageSize Number of intended items in the response page. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
