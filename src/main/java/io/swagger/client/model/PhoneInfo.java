...
public class PhoneInfo {
   ...
   * @return countryCode
  **/
  @ApiModelProperty(value = "The phone Info country code required for the participant to view and sign the document if authentication method is PHONE")
   ...
   * @return phone
  **/
  @ApiModelProperty(value = "The phone number required for the participant to view and sign the document if authentication method is PHONE")
