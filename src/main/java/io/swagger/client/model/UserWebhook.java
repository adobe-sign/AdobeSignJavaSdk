...
import io.swagger.client.model.WebhookUrlInfo;
...
public class UserWebhook {
  ...
  **/
   ...
   * @return resourceType
  **/
  @ApiModelProperty(value = "The resource for which you want to create webhook. Need to specify only if scope is 'RESOURCE'. Can't be modified in PUT request. The possible values are AGREEMENT, WIDGET and MEGASIGN.")
