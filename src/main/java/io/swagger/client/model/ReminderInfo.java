...
public class ReminderInfo {
  ...
  **/
  ...
  public ReminderInfo lastSentDate(Date lastSentDate) {
   ...
   /**
   * The date when the reminder was last sent. Only provided in GET. Cannot be provided in POST request. If provided in POST, it will be ignored. Format would be yyyy-MM-dd&#39;T&#39;HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
   * @return lastSentDate
  **/
  @ApiModelProperty(value = "The date when the reminder was last sent. Only provided in GET. Cannot be provided in POST request. If provided in POST, it will be ignored. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time")
  ...
  public ReminderInfo nextSentDate(Date nextSentDate) {
   ...
   /**
   * The date when the reminder is scheduled to be sent next. Only provided in GET. Cannot be provided in POST request. If provided in POST, it will be ignored. Format would be yyyy-MM-dd&#39;T&#39;HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
   * @return nextSentDate
  **/
  @ApiModelProperty(value = "The date when the reminder is scheduled to be sent next. Only provided in GET. Cannot be provided in POST request. If provided in POST, it will be ignored. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time")
  ...
  public ReminderInfo note(String note) {
   ...
   /**
   * An optional message sent to the recipients, describing why their signatures are required
   * @return note
  **/
  @ApiModelProperty(value = "An optional message sent to the recipients, describing why their signatures are required")
  ...
  public ReminderInfo addRecipientParticipantIdsItem(String recipientParticipantIdsItem) {
   ...
   /**
   * A list of one or more participant IDs to create the reminder on. The reminder will be sent to all the participants specified by the list of participant IDs.
   * @return recipientParticipantIds
  **/
  @ApiModelProperty(value = "A list of one or more participant IDs to create the reminder on. The reminder will be sent to all the participants specified by the list of participant IDs.")
   ...
   * @return reminderId
  **/
  @ApiModelProperty(value = "An identifier of the reminder resource created on the server. Only provided in GET. Cannot be provided in POST request. If provided in POST, it will be ignored")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Current status of the reminder")
