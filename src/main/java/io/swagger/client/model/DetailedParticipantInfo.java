...
public class DetailedParticipantInfo {
  ...
  **/
  @ApiModelProperty(value = "Security options that apply to the participant. This cannot be changed as part of the PUT call")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The status of the participant. This cannot be changed as part of the PUT call.")
