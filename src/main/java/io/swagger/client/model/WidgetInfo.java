...
import io.swagger.client.model.WidgetAdditionalParticipationSetInfo;
import io.swagger.client.model.WidgetCcInfo;
import io.swagger.client.model.WidgetParticipantSetInfo;
import io.swagger.client.model.WidgetRedirectionInfo;
...
public class WidgetInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalParticipantSetsInfo, authFailureInfo, ccs, completionInfo, createdDate, creatorEmail, fileInfos, id, locale, name, securityOption, state, status, vaultingInfo, widgetParticipantSetInfo);
  }
