...
/**
 * A JSON  that contains  id of the newly created group.
 */
@ApiModel(description = "A JSON  that contains  id of the newly created group.")
...
public class GroupCreationResponse {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Unique identifier of the group created.")
  public String getId() {
    return id;
  }
