...
public class ParticipantSetMemberInfo {
  ...
  **/
  ...
  public ParticipantSetMemberInfo email(String email) {
   ...
   /**
   * Email of the participant. It should be blank for the unknown participants.
   * @return email
  **/
  @ApiModelProperty(value = "Email of the participant. It should be blank for the unknown participants.")
