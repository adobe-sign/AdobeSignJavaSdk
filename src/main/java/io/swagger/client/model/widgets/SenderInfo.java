...
public class SenderInfo {
  ...
  public SenderInfo participantId(String participantId) {
   ...
   /**
   *  The unique identifier of the creator of the web form.
   * @return participantId
  **/
  @ApiModelProperty(value = " The unique identifier of the creator of the web form.")
  ...
  **/
  ...
  public SenderInfo self(Boolean self) {
   ...
   /**
   * True if the creator of the web form is the same user that is calling the API.
   * @return self
  **/
  @ApiModelProperty(value = "True if the creator of the web form is the same user that is calling the API.")
  ...
  **/
  ...
  public SenderInfo email(String email) {
   ...
   /**
   * Email of the creator of the web form.
   * @return email
  **/
  @ApiModelProperty(value = "Email of the creator of the web form.")
