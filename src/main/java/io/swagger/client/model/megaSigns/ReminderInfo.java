...
public class ReminderInfo {
  ...
  @SerializedName("allUnsigned")
  private Boolean allUnsigned = null;
  ...
  **/
  ...
  public ReminderInfo addRecipientParticipantIdsItem(String recipientParticipantIdsItem) {
   ...
   /**
   * A list of one or more participant IDs that the reminder should be sent to. These must be sharees or cc&#39;s on the MegaSign. In order to remind any other participant who has not signed, use the allUnsigned boolean parameter.
   * @return recipientParticipantIds
  **/
  @ApiModelProperty(value = "A list of one or more participant IDs that the reminder should be sent to. These must be sharees or cc's on the MegaSign. In order to remind any other participant who has not signed, use the allUnsigned boolean parameter.")
  ...
  **/
  ...
  public ReminderInfo allUnsigned(Boolean allUnsigned) {
    this.allUnsigned = allUnsigned;
    return this;
  }

   /**
   * If true, set a reminder on all participants (non-CCs and non-sharees) that still need to sign the MegaSign agreement
   * @return allUnsigned
  **/
  @ApiModelProperty(value = "If true, set a reminder on all participants (non-CCs and non-sharees) that still need to sign the MegaSign agreement")
  public Boolean isAllUnsigned() {
    return allUnsigned;
  }

  public void setAllUnsigned(Boolean allUnsigned) {
    this.allUnsigned = allUnsigned;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.note, reminderInfo.note) &&
        ...
        Objects.equals(this.firstReminderDelay, reminderInfo.firstReminderDelay) &&
        ...
        Objects.equals(this.allUnsigned, reminderInfo.allUnsigned) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(note, lastSentDate, nextSentDate, reminderId, firstReminderDelay, recipientParticipantIds, startReminderCounterFrom, allUnsigned, frequency, status);
  }
