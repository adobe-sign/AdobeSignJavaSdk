...
import io.swagger.client.model.megaSigns.ParticipantSecurityOption;
...
public class DetailedParticipantInfo {
  ...
  **/
   ...
   * @return self
  **/
  @ApiModelProperty(value = "True if this participant is the same user that is calling the API.")
  ...
  **/
  ...
  public DetailedParticipantInfo email(String email) {
   ...
   /**
   * Email of the participant. This is the required field and will always be returned unless it is a fax workflow (legacy megaSigns) that were created using fax as input
   * @return email
  **/
  @ApiModelProperty(value = "Email of the participant. This is the required field and will always be returned unless it is a fax workflow (legacy megaSigns) that were created using fax as input")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The status of the participant.")
