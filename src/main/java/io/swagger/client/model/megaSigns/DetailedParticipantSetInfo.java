...
import io.swagger.client.model.megaSigns.DetailedParticipantInfo;
...
public class DetailedParticipantSetInfo {
  ...
  **/
  ...
  public DetailedParticipantSetInfo name(String name) {
   ...
   /**
   * Name of ParticipantSet (it can be empty, but needs not to be unique in a single megaSign). Maximum no of characters in participant set name is restricted to 255.
   * @return name
  **/
  @ApiModelProperty(value = "Name of ParticipantSet (it can be empty, but needs not to be unique in a single megaSign). Maximum no of characters in participant set name is restricted to 255.")
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The unique identifier of the participant set.")
  public String getId() {
    return id;
  }
