...
public class FetchedMegaSignInfo {
  ...
  public FetchedMegaSignInfo firstReminderDelay(Integer firstReminderDelay) {
  ...
  **/
  ...
  public FetchedMegaSignInfo groupId(String groupId) {
    this.groupId = groupId;
    return this;
  }

   /**
   * The unique identifier of the group to which the megasign agreement will belong to when it is created. If it is not provided during agreement creation the primary group of the creator will be used
   * @return groupId
  **/
  @ApiModelProperty(value = "The unique identifier of the group to which the megasign agreement will belong to when it is created. If it is not provided during agreement creation the primary group of the creator will be used")
  ...
  public FetchedMegaSignInfo childAgreementsInfo(ChildAgreementsInfo childAgreementsInfo) {
  ...
  **/
  ...
  public FetchedMegaSignInfo signatureType(SignatureTypeEnum signatureType) {
  ...
  **/
  ...
  public FetchedMegaSignInfo externalId(ExternalId externalId) {
  ...
  **/
  ...
  public FetchedMegaSignInfo locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  **/
  ...
  public FetchedMegaSignInfo message(String message) {
  ...
  **/
  ...
  public FetchedMegaSignInfo vaultingInfo(VaultingInfo vaultingInfo) {
  ...
  **/
  ...
  public FetchedMegaSignInfo securityOption(MegaSignSecurityOption securityOption) {
  ...
  **/
  ...
  public FetchedMegaSignInfo postSignOption(PostSignOption postSignOption) {
  ...
  **/
  ...
  public FetchedMegaSignInfo reminderFrequency(ReminderFrequencyEnum reminderFrequency) {
  ...
  **/
  ...
  public FetchedMegaSignInfo ccs(List<MegaSignCcInfo> ccs) {
    this.ccs = ccs;
    return this;
  }

  public FetchedMegaSignInfo addCcsItem(MegaSignCcInfo ccsItem) {
    if (this.ccs == null) {
  ...
  **/
  ...
  public FetchedMegaSignInfo createdDate(Date createdDate) {
  ...
  **/
  ...
  public FetchedMegaSignInfo isDocumentRetentionApplied(Boolean isDocumentRetentionApplied) {
  ...
  **/
  ...
  public FetchedMegaSignInfo expirationTime(Date expirationTime) {
  ...
  **/
  ...
  public FetchedMegaSignInfo lastEventDate(Date lastEventDate) {
    this.lastEventDate = lastEventDate;
    return this;
  }

   /**
   * The date of the last event that occurred for this megasign.  Format would be yyyy-MM-dd&#39;T&#39;HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
   * @return lastEventDate
  **/
  @ApiModelProperty(value = "The date of the last event that occurred for this megasign.  Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time")
  ...
  public FetchedMegaSignInfo senderEmail(String senderEmail) {
  ...
  **/
  ...
  public FetchedMegaSignInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public FetchedMegaSignInfo numChildren(Integer numChildren) {
    this.numChildren = numChildren;
    return this;
  }

   /**
   * The total number of MegaSign children associated with the MegaSign parent. If provided in POST, it will be ignored. If modified in PUT, it will throw error MODIFYING_IMMUTABLE_FIELDS
   * @return numChildren
  **/
  @ApiModelProperty(value = "The total number of MegaSign children associated with the MegaSign parent. If provided in POST, it will be ignored. If modified in PUT, it will throw error MODIFYING_IMMUTABLE_FIELDS")
  ...
  public FetchedMegaSignInfo fileInfos(List<FileInfo> fileInfos) {
    this.fileInfos = fileInfos;
    return this;
  }

  public FetchedMegaSignInfo addFileInfosItem(FileInfo fileInfosItem) {
  ...
  **/
  ...
  public FetchedMegaSignInfo id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public FetchedMegaSignInfo state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public FetchedMegaSignInfo status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FetchedMegaSignInfo fetchedMegaSignInfo = (FetchedMegaSignInfo) o;
    return Objects.equals(this.firstReminderDelay, fetchedMegaSignInfo.firstReminderDelay) &&
        Objects.equals(this.groupId, fetchedMegaSignInfo.groupId) &&
        Objects.equals(this.childAgreementsInfo, fetchedMegaSignInfo.childAgreementsInfo) &&
        Objects.equals(this.signatureType, fetchedMegaSignInfo.signatureType) &&
        Objects.equals(this.externalId, fetchedMegaSignInfo.externalId) &&
        Objects.equals(this.locale, fetchedMegaSignInfo.locale) &&
        Objects.equals(this.message, fetchedMegaSignInfo.message) &&
        Objects.equals(this.vaultingInfo, fetchedMegaSignInfo.vaultingInfo) &&
        Objects.equals(this.securityOption, fetchedMegaSignInfo.securityOption) &&
        Objects.equals(this.postSignOption, fetchedMegaSignInfo.postSignOption) &&
        Objects.equals(this.reminderFrequency, fetchedMegaSignInfo.reminderFrequency) &&
        Objects.equals(this.ccs, fetchedMegaSignInfo.ccs) &&
        Objects.equals(this.createdDate, fetchedMegaSignInfo.createdDate) &&
        Objects.equals(this.isDocumentRetentionApplied, fetchedMegaSignInfo.isDocumentRetentionApplied) &&
        Objects.equals(this.expirationTime, fetchedMegaSignInfo.expirationTime) &&
        Objects.equals(this.lastEventDate, fetchedMegaSignInfo.lastEventDate) &&
        Objects.equals(this.senderEmail, fetchedMegaSignInfo.senderEmail) &&
        Objects.equals(this.name, fetchedMegaSignInfo.name) &&
        Objects.equals(this.numChildren, fetchedMegaSignInfo.numChildren) &&
        Objects.equals(this.fileInfos, fetchedMegaSignInfo.fileInfos) &&
        Objects.equals(this.id, fetchedMegaSignInfo.id) &&
        Objects.equals(this.state, fetchedMegaSignInfo.state) &&
        Objects.equals(this.status, fetchedMegaSignInfo.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstReminderDelay, groupId, childAgreementsInfo, signatureType, externalId, locale, message, vaultingInfo, securityOption, postSignOption, reminderFrequency, ccs, createdDate, isDocumentRetentionApplied, expirationTime, lastEventDate, senderEmail, name, numChildren, fileInfos, id, state, status);
  }
  ...
  public String toString() {
    ...
    sb.append("class FetchedMegaSignInfo {\n");
