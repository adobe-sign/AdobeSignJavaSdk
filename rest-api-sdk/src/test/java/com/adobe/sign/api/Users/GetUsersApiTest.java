...
/**
 * Junit test cases for Get Users endpoint.
 */
public class GetUsersApiTest {
  ...
  public void testNullAndEmptyAccessToken() throws ApiException {
    ...
    try {
      UsersInfo userInfos = usersApi.getUsers(ApiUtils.getNullAccessTokenHeaderParams(),
    ...
    try {
      UsersInfo userInfos = usersApi.getUsers(ApiUtils.getEmptyAccessTokenHeaderParams(),
                                              TestData.X_USER_EMAIL);
      assertNotNull(userInfos);
    }
    catch (ApiException e) {
  ...
  public void testInvalidXApiUser() throws ApiException {
    ...
    try {
      UsersInfo userInfos = usersApi.getUsers(ApiUtils.getEmptyXApiUserHeaderParams(),
                                              TestData.X_USER_EMAIL);
      assertNotNull(userInfos);
    }
    catch (ApiException e) {
