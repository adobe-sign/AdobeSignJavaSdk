...
/**
 * Junit test cases for Create Agreements Alternate Participants endpoint.
 */
public class CreateAgreementsAlternateParticipantsApiTest {
  ...
  public void testNullAndEmptyAccessToken() throws ApiException {
    ...
    try {
      AlternateParticipantResponse alternateParticipantResponse = agreementsApi.createAlternateParticipant(ApiUtils.getNullAccessTokenHeaderParams(),
                                                                                                           agreementId,
                                                                                                           participantSetId,
                                                                                                           participantId,
                                                                                                           updateInfo);
      assertNotNull(alternateParticipantResponse);
    ...
    try {
      AlternateParticipantResponse alternateParticipantResponse = agreementsApi.createAlternateParticipant(ApiUtils.getEmptyAccessTokenHeaderParams(),
                                                                                                           agreementId,
                                                                                                           participantSetId,
                                                                                                           participantId,
                                                                                                           updateInfo);
  ...
  public void testInvalidXApiUser() throws ApiException {
    ...
    try {
      AlternateParticipantResponse alternateParticipantResponse = agreementsApi.createAlternateParticipant(ApiUtils.getEmptyXApiUserHeaderParams(),
                                                                                                           agreementId,
                                                                                                           participantSetId,
                                                                                                           participantId,
                                                                                                           updateInfo);
  ...
  public void testInvalidAgreementId() throws ApiException {
    ...
    try {
      AlternateParticipantResponse alternateParticipantResponse = agreementsApi.createAlternateParticipant(ApiUtils.getValidHeaderParams(),
  ...
  public void testCreateAlternateParticipant() throws ApiException {
    ...
    try {
      AlternateParticipantResponse alternateParticipantResponse = agreementsApi.createAlternateParticipant(ApiUtils.getValidHeaderParams(),
                                                                                                           ...
                                                                                                           updateInfo);
      assertNotNull(alternateParticipantResponse);
      assertNotNull(alternateParticipantResponse.getParticipantId());
    }
    catch (ApiException e) {
