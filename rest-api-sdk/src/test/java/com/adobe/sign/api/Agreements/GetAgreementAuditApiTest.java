...
public class GetAgreementAuditApiTest {
  ...
  public void testNullAndEmptyAccessToken() throws ApiException {
    ...
    try {
      agreementsApi.getAuditTrail(TestData.NULL_PARAM,
                                  agreementId,
    ...
    try {
      agreementsApi.getAuditTrail(TestData.EMPTY_PARAM,
                                  agreementId,
                                  TestData.X_API_HEADER);
    }
    catch (ApiException e) {
  ...
  public void testInvalidXApiUser() throws ApiException {
    ...
    try {
      agreementsApi.getAuditTrail(TestData.ACCESS_TOKEN,
                                  agreementId,
  ...
  public void testGetAuditTrail() throws ApiException {
    ...
    try {
      byte[] audit = agreementsApi.getAuditTrail(TestData.ACCESS_TOKEN,
                                                 agreementId,
                                                 TestData.X_API_HEADER);
      assertNotNull(audit);
    }
