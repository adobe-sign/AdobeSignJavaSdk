...
public class DocumentCreationInfo   {
  ...
  private List<CcsInfo> ccs = new ArrayList<CcsInfo>();
  private Integer daysUntilSigningDeadline = null;
  private List<CustomWorkflowFileInfo> fileInfos = new ArrayList<CustomWorkflowFileInfo>();
  private List<FileInfo> formFieldLayerTemplates = new ArrayList<FileInfo>();
  private List<WorkflowBasedFormField> formFields = new ArrayList<WorkflowBasedFormField>();
  ...
  private List<RecipientsInfo> recipientsListInfo = new ArrayList<RecipientsInfo>();
