...
public enum WebIdentityProtectionEnum {
   ...
   **/
  @ApiModelProperty(value = "The secondary password that will be used to protect signing the widget for external signers. Note that Adobe Sign will never show this password to anyone, so you will need to separately communicate it to any relevant parties. This password is applied only if password protection is specified for external signers or all signers")
   ...
   **/
  @ApiModelProperty(value = "Signers need to pass Knowledge Based Authentication before they gain access to view and sign the widget.")
  @JsonProperty("kbaProtection")
  /**
   * @return KbaProtectionEnum
   **/
   ...
   **/
  @ApiModelProperty(value = "Specifies if signers are required to enter a password to have access to sign the widget.")
  @JsonProperty("passwordProtection")
  /**
   * @return PasswordProtectionEnum
   **/
   ...
   **/
  @ApiModelProperty(value = "Specifies if signers are required to provide their web identity, before they gain access to view and sign the widget.")
  @JsonProperty("webIdentityProtection")
  /**
   * @return WebIdentityProtectionEnum
   **/
