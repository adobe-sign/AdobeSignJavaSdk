...
public class FileInfo   {
  ...
  /**
   * The documentID as returned from the API to create transient documents
   **/
  @ApiModelProperty(value = "The documentID as returned from the API to create transient documents")
