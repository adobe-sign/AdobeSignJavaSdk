...
public class      AgreementsApiValidator {
   ...
   * @throws ApiException
   */
   public static void getAgreementsValidator(String accessToken, 
                                             String xApiUser, 
                                             String query, 
                                             String externalId, 
    ...
    * @throws ApiException
    */
   public static void createAgreementValidator(String accessToken, 
  ...
  /**
    ...
    * @throws ApiException
    */
   public static void getAgreementInfoValidator(String accessToken, 
                                                String agreementId, 
                                                String xApiUser) throws ApiException {
     
     validateCommonAgreementParameters(accessToken, agreementId, xApiUser);
   }
    ...
    * @throws ApiException
    */
   public static void deleteAgreementValidator(String accessToken,
                                               String agreementId,
                                               String xApiUser) throws ApiException {
    ...
    * @throws ApiException
    */
   public static void getAuditTrailValidator(String accessToken, 
                                             String agreementId, 
                                             String xApiUser) throws ApiException {
    ...
    * @throws ApiException
    */
   public static void getCombinedDocumentPagesInfoValidator(String accessToken,
                                                            String agreementId,
                                                            String xApiUser,
    ...
    * @throws ApiException
    */
   public static void getCombinedDocumentUrlValidator(String accessToken,
                                                      String agreementId,
                                                      String xApiUser,
                                                      String versionId,
                                                      String participantEmail,
   ...
   * @throws ApiException
   */
  public static void getAllDocumentsValidator(String accessToken,
                                              String agreementId,
                                              String xApiUser,
                                              String versionId,
                                              String participantEmail,
   ...
   * @throws ApiException
   */
  public static void deleteDocumentsValidator(String accessToken,
                                              String agreementId,
                                              String xApiUser) throws ApiException {
   ...
   * @throws ApiException
   */
  public static void getCombinedDocumentImageUrlsValidator(String accessToken,
                                                           String agreementId,
                                                           String xApiUser,
                                                           String versionId,
                                                           String participantEmail,
   ...
   * @throws ApiException
   */
  public static void getDocumentValidator(String accessToken,
                                          String agreementId,
                                          String documentId,
                                          String xApiUser) throws ApiException {
   ...
   * @throws ApiException
   */
  public static void getDocumentImageUrlsValidator(String accessToken,
                                                   String agreementId,
                                                   String documentId,
                                                   String xApiUser,
                                                   String versionId,
                                                   ...
                                                   int startPage,
                                                   int endPage) throws ApiException {
   ...
   * @throws ApiException
   */
  public static void getDocumentUrlValidator(String accessToken,
                                             String agreementId,
                                             String documentId,
                                             String xApiUser,
                                             String versionId,
   ...
   * @throws ApiException
   */
  public static void getFormDataValidator (String accessToken, 
                                           String agreementId, 
                                           String xApiUser) throws ApiException {
   ...
   * @throws ApiException
   */
  public static void createAlternateParticipantValidator (String accessToken, 
                                                          String agreementId, 
   ...
   * @throws ApiException
   */
  public static void getSigningUrlValidator (String accessToken, 
                                             String agreementId, 
                                             String xApiUser) throws ApiException {
    validateCommonAgreementParameters(accessToken, agreementId, xApiUser);
  }
   ...
   * @throws ApiException
   */
  public static void updateStatusValidator(String accessToken,
                                           String agreementId,
  ...
  /**
   * Common method that validated the accessToken, xApiUser and agreementId
   */
  private static void validateCommonAgreementParameters(String accessToken,
                                                        String agreementId,
                                                        String xApiUser) throws ApiException {
